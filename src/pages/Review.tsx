...
import OKRReview from "components/review/OKRReview";
  ...
  return (
    ...
    >
      <div className="d-flex flex-column col h-100 p-0">
        <div className="d-flex flex-center mt-5 mb-10 review-top-select">
          <DropdownButton
              ...
              <div className="card card-custom flex-row h-100 review-result">
                        ...
                        <div className="review-tabs my-8 tab-menu">
                          ...
                          >
                            {[
                              ...
                              if (show)
                                return (
                                  <li className="h-50px cursor-pointer">
                                    <a
                                      className={`mx-0 pl-8 ${
                ...
                <div className="section-2 col-auto h-sm-100 flex-grow-1 w-100px d-flex flex-column px-0">
                  <div className="card card-custom card-stretch rounded-20 shadow-none">
                    <div className="card-body position-relative px-10 py-0">
                      <div
                        className="h-100 overflow-y-auto tab-container py-8"
                        ref={scrollRef}
                        onScroll={() => {
                          if (scrollRef.current) {
                            const {
                            ...
                            tabArr.forEach((tab, i) => {
                              if (scrollTop === 0) {
                                ...
                                setResultIndex(tabArr[tabArr.length - 1].index);
                              else if (
                      ...
                      >
                        {[
                          ...
                          else if (index === 3) review = <LeaderReviewResult />;
                          else if (index === 4) review = <TeamReviewResult />;
                          return (
                            <div id={`result_${index}`} key={`result_${index}`}>
                              {show ? review : <></>}
                            </div>
                          );
                        })}
